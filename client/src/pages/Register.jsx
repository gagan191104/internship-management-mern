          ...
          {role === "student" ? (
            <>
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input className="input" value={branch} onChange={(e) => setBranch(e.target.value)} required />
              </div>
              <div style={{ marginBottom: "1rem" }}>
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input className="input" type="number" step="0.01" min="0" max="10" value={gpa} onChange={(e) => setGpa(e.target.value)} required />
              </div>
              <div style={{ marginBottom: "1rem" }}>
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input className="input" type="file" accept="image/*" onChange={(e) => setProfilePhoto(e.target.files?.[0] || null)} />
              </div>
            </>
          ) : (
            <>
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input className="input" value={companySize} onChange={(e) => setCompanySize(e.target.value)} placeholder="e.g. 51-200 employees" />
              </div>
              <div style={{ marginBottom: "1rem" }}>
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input className="input" type="file" accept="image/*" onChange={(e) => setCompanyLogo(e.target.files?.[0] || null)} />
              </div>
              <div style={{ marginBottom: "1rem" }}>
                <label className="label">Description</label>
                <textarea className="textarea" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Tell us about your company..." />
              </div>
            </>
          )}
